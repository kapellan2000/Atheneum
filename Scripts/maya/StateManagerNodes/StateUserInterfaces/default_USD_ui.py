...
class Ui_wg_USD(object):
    def setupUi(self, wg_USD):
        if not wg_USD.objectName():
            wg_USD.setObjectName(u"wg_USD")
        wg_USD.resize(400, 1259)
        self.verticalLayout = QVBoxLayout(wg_USD)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.w_name = QWidget(wg_USD)
        ...
        self.gb_export = QGroupBox(wg_USD)
        ...
        self.retranslateUi(wg_USD)

        QMetaObject.connectSlotsByName(wg_USD)
    # setupUi

    def retranslateUi(self, wg_USD):
        wg_USD.setWindowTitle(QCoreApplication.translate("wg_USD", u"Export", None))
        self.l_name.setText(QCoreApplication.translate("wg_USD", u"Name:", None))
        self.l_class.setText(QCoreApplication.translate("wg_USD", u"Export", None))
        self.gb_export.setTitle(QCoreApplication.translate("wg_USD", u"General", None))
        self.label_4.setText(QCoreApplication.translate("wg_USD", u"Context:", None))
        self.l_context.setText("")
        self.b_context.setText(QCoreApplication.translate("wg_USD", u"Select", None))
        self.l_tasklabel.setText(QCoreApplication.translate("wg_USD", u"Productname:", None))
        self.l_taskName.setText("")
        self.b_changeTask.setText(QCoreApplication.translate("wg_USD", u"change", None))
        self.label_3.setText(QCoreApplication.translate("wg_USD", u"Framerange:", None))
        self.l_rangeEnd.setText(QCoreApplication.translate("wg_USD", u"1100", None))
        self.l_rangeStart.setText(QCoreApplication.translate("wg_USD", u"1001", None))
        self.l_rangeStartInfo.setText(QCoreApplication.translate("wg_USD", u"Start:", None))
        self.l_rangeEndInfo.setText(QCoreApplication.translate("wg_USD", u"End:", None))
        self.l_master.setText(QCoreApplication.translate("wg_USD", u"Update Master Version:", None))
        self.chb_master.setText("")
        self.l_outPath.setText(QCoreApplication.translate("wg_USD", u"Location:", None))
        self.l_outType.setText(QCoreApplication.translate("wg_USD", u"Outputtype:", None))
        self.l_cam.setText(QCoreApplication.translate("wg_USD", u"Camera:", None))
        self.l_sCamShot.setText(QCoreApplication.translate("wg_USD", u"Shot:", None))
        self.b_selectCam.setText(QCoreApplication.translate("wg_USD", u"Select", None))
        #self.l_additionalOptions.setText(QCoreApplication.translate("wg_USD", u"Show additional options on publish:", None))
        self.chb_additionalOptions.setText("")
        self.l_wholeScene.setText(QCoreApplication.translate("wg_USD", u"Export whole Scene:", None))
        self.chb_wholeScene.setText("")
        self.gb_objects.setTitle(QCoreApplication.translate("wg_USD", u"Objects", None))
        self.b_add.setText(QCoreApplication.translate("wg_USD", u"Add selected", None))
        #self.gb_submit.setTitle(QCoreApplication.translate("wg_USD", u"Submit Render Job", None))
        self.l_manager.setText(QCoreApplication.translate("wg_USD", u"Manager:", None))
        self.l_rjPrio.setText(QCoreApplication.translate("wg_USD", u"Priority:", None))
        self.label_15.setText(QCoreApplication.translate("wg_USD", u"Frames per Task:", None))
        self.l_rjTimeout.setText(QCoreApplication.translate("wg_USD", u"Task Timeout (min)", None))
        self.label_18.setText(QCoreApplication.translate("wg_USD", u"Submit suspended:", None))
        self.chb_rjSuspended.setText("")
        self.l_dlConcurrentTasks.setText(QCoreApplication.translate("wg_USD", u"Concurrent Tasks:", None))
        self.gb_previous.setTitle(QCoreApplication.translate("wg_USD", u"Last export", None))
        self.l_pathLast.setText(QCoreApplication.translate("wg_USD", u"None", None))
        self.b_pathLast.setText(QCoreApplication.translate("wg_USD", u"...", None))
    # retranslateUi

#from default_USD import USDClass
#USD_uiClass = USDClass  # 👈 для Prism
#Ui_wg_USD_ui = Ui_wg_USD