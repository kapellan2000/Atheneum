...
class USDClass(object):
    className = "USD"
    listType = "Export"
    stateCategories = {"USD": [{"label": className, "stateType": className}]}
    ...
    def executeState(self, parent, useVersion="next"):
        ...
        try:
            ...
            if not self.gb_submit.isHidden() and self.gb_submit.isChecked():
                ...
                outputName = self.core.getPlugin("Atheneum").sm_export_exportAppObjects(
                    self,
                    startFrame=startFrame,
                    endFrame=endFrame,
