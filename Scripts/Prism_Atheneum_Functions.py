...
class Prism_Atheneum_Functions(object):
    ...
    def startup(self, origin):
        ...
        # 		if obj.objectName() == 'AtheneumWindow':
        # 			QtParent = obj
        # 			break
        # 	else:
        # 		return False
    ...
    def onProjectBrowserStartup(self, origin):
        ...
        origin.mediaBrowser.sl_preview.mousePressEvent = origin.mediaBrowser.sl_preview.origMousePressEvent
